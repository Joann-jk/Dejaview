...
const ROLES = [
  "Egyptian cat worshipper",
  "medieval potato farmer",
  "pirate’s pet parrot",
  "royal sock designer",
  "moon cheese inspector",
  "18th century bread thief",
]

const DEATHS = [
  "fell into a giant soup pot",
  "was tickled to death by geese",
  "got lost in your own beard",
  "challenged a pigeon to a duel",
  "accidentally invented soap and hated it",
]

const PERSONALITIES = [
  "extremely dramatic",
  "afraid of spoons",
  "convinced the moon was made of garlic",
  "could talk to rocks (but they ignored you)",
]
...
const SKILL_POOL = [
  ...
  "Aura Reading",
  "Soup Avoidance",
  "Treasure Misplacement",
  "Royal Etiquette (Chaotic)",
]
